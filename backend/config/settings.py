...
# Email Configuration
# Dynamically use SMTP if credentials exist in .env, otherwise fall back to console to prevent crashes
...
DEFAULT_FROM_EMAIL  = os.environ.get('EMAIL_HOST_USER', 'noreply@inkcloud.com')
